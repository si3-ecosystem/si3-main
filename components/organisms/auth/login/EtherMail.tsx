...
const EtherMail = () => {
  ...
  useEffect(() => {
    ...
    // Attach event listener for successful login
    document.addEventListener("ethermail-login-success", handleSuccess);

    return () => {
      document.removeEventListener("ethermail-login-success", handleSuccess);
    };
  }, []);
