...
export default function MiddleHeading({
  ...
  return (
    <div className="relative mx-auto mb-8 w-full text-center">
      <motion.h1
        className="font-clesmont text-7xl leading-tight font-bold tracking-tight whitespace-nowrap text-black max-sm:text-5xl md:text-8xl lg:text-9xl 2xl:text-[190px]"
